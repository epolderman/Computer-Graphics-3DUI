...
const vec3 theDiffuseMaterial = vec3(0.25f, 0.20725f, 0.20725f);
const vec3 theSpecularMaterial = vec3(0.75f, 0.829f, 0.829f);
const vec3 theAmbientMaterial = vec3(0.296648f, 0.296648f, 0.296648f);
const float shine = 0.088f;
...
{	
	...
	float specs = 0.0f;
	float shininessValue = shine * 128;
